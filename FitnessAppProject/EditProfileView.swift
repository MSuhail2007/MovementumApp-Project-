...
//  FitnessAppProject
//
//  Created by Mohammed suhail on 03/10/2025.
//
        ...
        NavigationView {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .cancellationAction) {
                    Button("Cancel") { dismiss() }.foregroundColor(Theme.accentColor)
                }
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save", action: saveProfile).foregroundColor(Theme.accentColor)
                }
            }
        }
    }
